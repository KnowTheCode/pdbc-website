 ...
 * Metabox
 *
 * @package     KnowTheCode\LiveEvent\Admin\Metabox
 * @since       1.0.0
...
namespace KnowTheCode\LiveEvent\Admin\Metabox;
...
class Metabox {
	...
	protected function is_root_page() {
		return fulcrum_get_post_id() == get_option( 'page_on_front' );
	}
